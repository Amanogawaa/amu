    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="mx-auto w-[350px] gap-6">
        ...
        <form className="grid gap-4">
          ...
          <div className="relative grid gap-2">
            <Lock className="pointer-events-none  text-Midnight_Pine absolute inset-y-3.5 left-0 flex w-7 items-center pl-3 " />
            <Input
              id="password"
              type="password"
              required
              placeholder="password"
              className="rounded-xl border border-Winter_Teal placeholder:text-base p-6 pl-8 active:border-Winter_Teal focus:border- focus:outline-none focus-visible:ring-0"
            />
          </div>
          <Button
            type="submit"
