...
import { useAppAssistant } from "../application/useAppAssistant";
    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button
          ...
          title="Open CourseCraft Assistant"
        >
        ...
        <SheetHeader className="p-6 pb-4 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1">
              <SheetTitle>CourseCraft Assistant</SheetTitle>
              <SheetDescription>
                Ask questions about technical terms or the application
              </SheetDescription>
            </div>
            {messages.length > 0 && (
              <Button
            ...
            {isInitializing ? (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Setting up your personalized application assistant
                  </p>
                </div>
              </div>
            ) : messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-6">
                ...
                <div className="space-y-2 max-w-sm">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ask me anything about CourseCraft features, technical concepts,
                    or glossary terms.
                  </p>
                </div>
              ...
              <div className="space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      <div className={cn("text-sm", message.role === "assistant" ? "prose prose-sm dark:prose-invert max-w-none break-words" : "whitespace-pre-wrap")}>
                        {message.role === "assistant" ? (
        ...
        <div className="p-4 border-t bg-background flex-shrink-0">
          <div className="flex gap-2">
            <Textarea
              ...
              placeholder="Ask a question about CourseCraft..."
