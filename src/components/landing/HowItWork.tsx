...
export default function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="bg-gradient-to-b from-background via-background/40 to-secondary/10 px-4 py-24 text-foreground"
    >
      <div className="mx-auto max-w-7xl space-y-16">
        <div className="space-y-4 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            The same loop used to build the thesis project—grounded, repeatable,
            and honest.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-4">
          {steps.map((step) => (
            <div
              key={step.title}
              className="rounded-3xl border border-border/60 bg-card/80 p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
            >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {cards.map((card) => (
            <div
              key={card.title}
              className="rounded-3xl border border-border/60 bg-card/80 p-6 text-center shadow-sm"
            >
              <div className="mb-3 text-3xl flex items-center justify-center">
                {card.icon}
              </div>
